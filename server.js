...
api.use('/api', expressJwt({ secret: config.secret, algorithms: [config.algorithms] }).unless({ path: ['/api/about','/api/users/authenticate', '/api/users/register'] }));
api.use('/api/camera', require('./controllers/api/camera.controller'));
